  ...
  return (
    ...
    >
      ...
      <g className={styles.g1}>
        <circle className={styles.ring} cx="12" cy="16" r="11.625" stroke="var(--ink)" strokeWidth=".75" />
      ...
      <g className={styles.g3}>
        <circle className={styles.eclipseBack} cx="180" cy="12" r="11.625" fill="var(--ink)" stroke="var(--ink)" strokeWidth=".75" />
        <circle className={styles.eclipseFront} cx="188" cy="21" r="11.625" fill="var(--paper)" stroke="var(--ink)" strokeWidth=".75" />
      </g>

      {/* glyph 4 — target */}
      <g className={styles.g4}>
        <circle className={styles.ring} cx="272" cy="16" r="11.625" stroke="var(--ink)" strokeWidth=".75" />
        <circle className={styles.dot} cx="272" cy="13" r="3" fill="var(--ink)" />
      </g>
    </svg>
  );
}
